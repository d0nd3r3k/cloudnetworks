...
module.exports = {
  ...
  test: {},
  production: {
    db: 'mongodb://89.17.121.194/cloudnetworks',
    root: rootPath,
    notifier: notifier,
    app: {
      name: 'Cloudnetworks Cloud Server - Production'
    },
    facebook: {
      clientID: "371211122956820",
      clientSecret: "5c7850b638eae37894c55d42237782a9",
      callbackURL: "http://89.17.121.194:8080/auth/facebook/callback"
    },
    twitter: {
      clientID: "IDxMydmv0kbWRgH0ESGpNQ",
      clientSecret: "OCGTkWcUWsGs75Ca9vDoEvmrnXon7ELO3hbMsbg6OFU",
      callbackURL: "http://89.17.121.194:8080/auth/twitter/callback"
    },
    github: {
      clientID: 'edff7f6fa8786db9c78a',
      clientSecret: '1cafc8709a10cb33d98f6d34f0c94fc44c8116a1',
      callbackURL: 'http://89.17.121.194:8080/auth/github/callback'
    },
    google: {
      clientID: "33125564461.apps.googleusercontent.com",
      clientSecret: "L1qzCcoCzMWihIPacyjbHeOB",
      callbackURL: "http://89.17.121.194:8080/auth/google/callback"
    },
